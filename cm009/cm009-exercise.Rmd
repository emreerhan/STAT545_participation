...
```{r}
lotr1 = read_csv('The_Fellowship_Of_The_Ring.csv')
lotr2 = read_csv('The_Two_Towers.csv')
lotr3 = read_csv('The_Return_Of_The_King.csv')
...
df %>% complete(year = full_seq(year, 1))
